...
import {
  ScanTypeSelector,
  type ScanConfig,
} from "@/components/ui/scan-type-selector";
import {
  Shield,
  AlertTriangle,
  Search,
...
export default function LandingPage() {
  ...
  const handleScanStart = async (config: ScanConfig) => {
    ...
    if (
      !user &&
      (config.scanType === "repository" || config.scanType === "deep")
    ) {
      router.push("/login");
      return;
    }
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/stegoshield" className="inline-block">
              <Button className="bg-black hover:bg-gray-800 text-white px-4 py-2 text-sm font-semibold rounded-lg shadow">
                Try StegoShield
              </Button>
            </Link>
          </div>
          ...
          <p className="text-xl sm:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Advanced AI-powered security scanner with deep HTML & JavaScript
            file analysis that detects exposed API keys, secrets, and
            vulnerabilities in your web applications instantly.
          </p>
          ...
          <div className="mt-6">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500 mt-3">
                GitHub Scan and Deep Scan require login.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive scanning and AI-powered analysis to keep your
              applications secure
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="rounded-2xl shadow-lg border-0 bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription className="text-gray-600 text-center text-lg leading-relaxed">
                  Advanced HTML & JavaScript file scanning with CDN filtering,
                  caching, and 70+ security patterns for comprehensive threat
                  detection
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl shadow-lg border-0 bg-gradient-to-br from-purple-50 to-purple-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription className="text-gray-600 text-center text-lg leading-relaxed">
                  Intelligent security assessment with contextual insights and
            ...
            <Card className="rounded-2xl shadow-lg border-0 bg-gradient-to-br from-orange-50 to-orange-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription className="text-gray-600 text-center text-lg leading-relaxed">
                  Comprehensive security reports with severity levels and
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 mb-8">
              ThreatPeek is built with modern web technologies and follows best
              practices for security scanning applications.
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} ThreatPeek. All rights reserved.
